...
As we said in the introduction, the first element which can lead us to recognize if it is a speaker or multiple one to be analysed in a dataset would be the third formant values of that speaker. Here it is a global *f~3~* representation.   
